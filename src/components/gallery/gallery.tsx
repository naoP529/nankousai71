    ...
    return(
        <div className="w-full">   
            ...
            <div className="w-full px-[5vw] flex flex-wrap justify-around pb-[10vw]">
                {img_tags.map((value) => (
                    <Link key={value.title} href={{pathname:"/gallery/preview", query:{title:value.title} }}>
                        <div className="w-[40vw] bg-white drop-shadow-lg rounded-md cursor-pointer">
                        <Image src={value.img} alt="image" width={1000} height={1000} className="w-full aspect-square object-cover object-left-top rounded-t-md"></Image>
