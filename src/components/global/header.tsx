        ...
        <header className="w-full h-[15vw] relative max-h-28">
            ...
            <div className="w-full h-full flex items-center justify-between">
                <Link href={"/"} onClick={clickLogo}>
                    <motion.div whileHover={{scale:1.05, opacity:1}} whileTap={{scale:0.9}} transition={{type:"spring", duration:0.2, bounce:0.2}} className="relative ml-[3.5vw] flex items-center opacity-90">
                        <Image src={"/70周年ロゴB.png"} alt="70周年ロゴ" width={500} height={500} className="h-[6.8vw] w-[7vw]"></Image>
                ...
                <div className="flex items-center  z-10 ml-[3vw] ">
                    <Link ref={targetButton} href={"/info"} onClick={clickButton}>
                        <motion.div whileHover={{scale:1.05, opacity:1}}  whileTap={{scale:0.95}} transition={{type:"spring", duration:0.2, bounce:0.1}} className={`relative w-[28vw] opacity-90`}>
                ...
                <motion.div whileHover={{opacity:1}} transition={{duration:0.1}} ref={targetIcon} className="w-[8vw] aspect-square cursor-pointer text-white ml-[2vw] mr-[3vw] opacity-70 z-20">
